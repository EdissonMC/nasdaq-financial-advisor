      ...
      <div style={{ background: 'var(--panel)', border: '1px solid var(--border)', borderRadius: 12, padding: 24, width: '90%', maxWidth: 420 }}>
        ...
        <div style={{ display: 'grid', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end' }}>
            ...
            <button onClick={handleSubmit} disabled={loading} style={{ padding: '10px 16px', border: '1px solid var(--border)', borderRadius: 8, background: 'var(--accent)', color: '#0b1020', fontWeight: 500 }}>{loading ? 'Signing in...' : 'Sign In'}</button>
          </div>
        </div>
      </div>
    </div>
